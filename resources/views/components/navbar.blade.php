...
{{--  language --}}
<li class="nav-item dropdown d-none d-lg-block  {{ Route::currentRouteName() == 'homepage' ? 'ms-1' : '' }} my-auto ps-2">
<a class="nav-link dropdown-toggle  py-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
@if (session('locale'))
<img src="{{ asset('vendor/blade-flags/language-' . session('locale') . '.svg') }}"
alt="{{ session('locale') }} Flag" width="32" height="32" class="">
@else
<img src="{{ asset('vendor/blade-flags/language-it.svg') }}" alt="it Flag" width="32" height="32" class="">
@endif
</a>
...
<div class="dropdown">
    <button class="btn btn-user px-2 py-2 fs-7 rounded-4 shadow" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    <i class="fa-solid fa-user fs-5 mx-2 icon"></i>Ciao {{Auth::user()->name}}</span>
    </button>
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="#">Action</a></li>
        <li><a class="dropdown-item" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">Wishlist</a></li>
        ...
        <li>
            ...
            <form action="{{ route('logout') }}" method="post">
                @csrf
                <button class="btn mx-2 "><i class="fa-solid fa-arrow-right-from-bracket fs-6"></i> Logout</button>
            </form>
        </li>
    </ul>
</div>
