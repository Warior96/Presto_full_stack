...
<div class="card mx-auto card-w shadow p-2 text-center mb-3 bg-info-subtle">
    ...
    <img src="https://picsum.photos/301/300" class="card-img-top img-fluid" alt="Immagine dell'articolo {{ $article->title }}">
    <div class="card-body">
        ...
        <div class=" mt-5 mx-3">
            ...
            <a href="{{ route('byCategory', ['category' => $article->category]) }}"
                class="btn btn-outline-info w-auto text-black">{{ $article->category->name }}</a>
             @endif
