        ...
        <div class="row justify-content-center">
            ...
            @auth
                ...
                <a href="{{ route('createarticle') }}"
                    class="btn btn-outline-info position-absolute text-dark p-3 fs-5 rounded shadow" id="addArticle">Pubblica
                    un articolo</a>
        ...
        <div class="row justify-content-center">
            ...
            @if ($articles)
                <swiper-container class="mySwiper" space-between="15" slides-per-view="3" pagination="false"
                    loop="true" autoplay-delay="1000" autoplay-pause-on-mouse-enter="true">
